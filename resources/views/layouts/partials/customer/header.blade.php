        ...
        <nav class="navbar navbar-expand-lg custom_nav-container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('customer.menu.index') }}">Menu</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('customer.shipping-address.index') }}">Shipping Address</a>
                    </li>
                </ul>
                ...
                <div class="user_option">
                    ...
                    <a class="cart_link" href="{{ route('customer.cart.index') }}">
                  ...
                  <g>
                        ...
                        <span id="cartItemCount" class="cart-badge">{{ $cartCount }}</span>
                    </a>
                </div>
            </div>
        </nav>
