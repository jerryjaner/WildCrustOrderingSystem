...
<div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
    ...
    <div class="container-fluid d-flex align-items-stretch justify-content-between" id="kt_header_container">
        ...
        <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
            <!--begin::Heading-->
            <h1 class="text-dark fw-bolder my-1 fs-2">@yield('page-title', 'Welcome to WildCrust Ordering System')
        ...
        <div class="d-flex d-lg-none align-items-center ms-n2 me-2">
            ...
            <a href="index.html" class="d-flex align-items-center">
                {{-- <img alt="Logo" src="admin/assets/media/logos/logo-compact.svg" class="max-h-40px" /> --}}
                {{-- <img alt="Logo" src="admin/assets/media/logos/wildcrust-logo.jpg" class="" /> --}}
            </a>
            <!--end::Logo-->
        </div>
        <!--end::Wrapper-->
        ...
        <div class="d-flex align-items-stretch flex-shrink-0">
            ...
            <div class="d-flex align-items-center ms-1 ms-lg-3">
                ...
                <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true">
                    <!--begin::Heading-->
                    <div class="d-flex flex-column bgi-no-repeat rounded-top" style="background-image:url('admin/assets/media/misc/pattern-2.jpg')">
                        <!--begin::Title-->
                        ...
                        <div class="tab-pane fade" id="kt_topbar_notifications_2" role="tabpanel">
                            ...
                            <div class="d-flex flex-column px-9">
                                ...
                                <div class="text-center mb-5 px-4">
                                    <img class="mw-100 mh-175px" alt="" src="admin/assets/media/illustrations/verification.png" />
                                </div>
                                <!--end::Illustration-->
                            </div>
                            <!--end::Wrapper-->
                    ...
                    <div class="menu-item px-3">
                        <div class="menu-content d-flex align-items-center px-3">
                            ...
                            <div class="symbol symbol-50px me-5">
                                <img alt="Logo" src="admin/assets/media/avatars/150-2.jpg" />
                            </div>
                            <!--end::Avatar-->
                            <!--begin::Username-->
