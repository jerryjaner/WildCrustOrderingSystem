      ...
      <div class="col-xxl-4">
         ...
         <div class="card card-xxl-stretch">
            ...
            <div class="card-body d-flex flex-column justify-content-between h-100">
               ...
               <!--end::Section-->
               <!--begin::Image-->
               <div class="flex-grow-1 bgi-no-repeat bgi-size-contain bgi-position-x-center bgi-position-y-bottom card-rounded-bottom h-150px" style="background-image:url('admin/assets/media/illustrations/user-welcome.png')"></div>
               <!--end::Image-->
            </div>
            <!--end::Card body-->
         </div>
